...
// const notes = document.querySelector("[data-task-input]").value;
...
// localStorage.setItem("myNotes", dataJSON);

// // Get data from local storage
// const storedDataJSON = localStorage.getItem("myNotes");

// // Parse JSON string back into object
// const storedData = JSON.parse(storedDataJSON);

// // Get date and notes from object
// const storedDate = new Date(storedData.date);
// const storedNotes = storedData.notes;
